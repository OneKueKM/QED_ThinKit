...
class FriendAddingScreen extends StatefulWidget {
  const FriendAddingScreen({Key? key}) : super(key: key);

  @override
  State<FriendAddingScreen> createState() => _FriendAddingScreenState();
}

int value = 0;

class _FriendAddingScreenState extends State<FriendAddingScreen> {
